        ...
        <link href="https://fonts.googleapis.com/css?family=Patua+One" rel="stylesheet">
            ...
            <=$match->player_total;$i++)
                            <div class="col-md-12">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" name="p_t1_{{$i}}" placeholder="Ex. Sakib Al Hasan" required="" type="text">
                                    </input>
                                </div>
                            </div>
                            @endfor
            ...
            <=$match->player_total;$i++)
                            <div class="col-md-12">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" name="p_t2_{{$i}}" placeholder="Ex. Sakib Al Hasan" required="" type="text">
                                    </input>
                                </div>
                            </div>
                            @endfor
